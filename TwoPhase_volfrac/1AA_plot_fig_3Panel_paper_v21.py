...
if PD==1 or PD==2:
	...
	if cont_out==1:
		if k==0:
			...
			dtype1 = np.dtype ([('z','f8'),('phi','f8'),('phi_wt','f8'),('h','f8'),('T','f8'),('Ts','f8'),
					('Tl','f8'),('cb','f8'),('cb_mg','f8'),
					('cs_mg','f8'),('cl_mg','f8'),('ol','f8'),('opx','f8'),
...
if cont_out==1:
	fig.savefig("Figure_of_output_3Panel_%s_paper.svg" %numb)
else:
	fig.savefig("Figure_of_output_line_%s.svg" %numb)
