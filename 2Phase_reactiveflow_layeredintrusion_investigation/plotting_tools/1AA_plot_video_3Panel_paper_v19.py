...
# title of figure
	...
	if PD==3:
		...
		ax4.fill_between((data['ol']+data['opx']+data['cpx']+data['feld'])*100,depth,color='#dcd57d',  label='plg')
		...
		ax5.legend(loc="bestoutside")
		ax5.set_xlim([0, 60])
		ax5.set_xlabel("MgO (%)",fontsize=16)
		ax5.set_ylabel("Depth (m)",fontsize=16) 
